...
export default function App() {
  ...
  const generateMessage = (resi: string) => {
    return encodeURIComponent(`Hallo Kami dari jnt lalan grai aini paket ada telah samapi dengan nomer resi ${resi}`);
  };
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-between">
              <div className="relative w-full sm:w-96">
                ...
                <input 
                  ...
                  className={`w-full pl-10 pr-4 py-2.5 rounded-2xl border outline-none transition-all ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200 focus:border-jt-red'}`}
                />
              </div>
            ...
            <AnimatePresence mode="popLayout">
              {filteredContacts.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center opacity-40">
                  ...
                  <h3 className="text-xl font-bold mb-2">Belum ada daftar kontak</h3>
                  <p className="max-w-xs mx-auto">Tambahkan kontak di panel sebelah kiri untuk memulai broadcast resi.</p>
                </div>
              )}
            </AnimatePresence>
